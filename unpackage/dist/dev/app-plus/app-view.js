...
{
  name: "refresh", props: ["type", "color", "playState"],
  data: function data() {
    return {
      wxsProps: {} };
            ...
            _vm._l(_vm._$g(2, "f"), function(article, index, $20, $30) {
              return _c(
                ...
                [
                  ...
                  _c("v-uni-text", { attrs: { _i: "4-" + $30 } }, [_vm._v(">")])
                ],
                1
              )
            }),
